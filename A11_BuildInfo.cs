...
namespace CS1_LaneBalancer
{
    ...
    {
        public const string HudBuildId = "HUD_FRAMEWORK_BIG_V1_STABLE";
        public const string ModVersion = "MOD_A11_HUD_OK_REPATH_060P_ONEKEY_F11";
        public const string ModStamp = "2026-03-03";
    }
}
